...
public class SetUserCommandParserTest {
    ...
    public void parse_validArgs_returnsSetUserCommand() {
        assertParseSuccess(parser, "1", new SetUserCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, SetUserCommand.MESSAGE_USAGE));
    }
}
