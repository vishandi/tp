...
* **New Features**: 
1) Added the ability to add events to a contact's schedule.
...
2) Add recurring event functionality.
...
3) Added the ability to import schedules.
...
4) Added the ability to clear a person's schedule.
...
5) Added the ability to set a contact as the user.
